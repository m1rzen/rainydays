...
const data = workerData as { fileName?: unknown; bytes?: unknown; options?: unknown };
...
if (!fileName || !bytes) {
  ...
  parseFileBuffer(fileName, bytes, data.options && typeof data.options === "object" ? data.options : {})
