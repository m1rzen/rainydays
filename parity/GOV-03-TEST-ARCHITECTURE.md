...
The default integration child budget is 720 seconds. The unified runner grants that layer 780 seconds, leaving a bounded 60-second envelope for atomic report publication and verified process-tree cleanup. Both remain below the 900-second hard ceiling; changing either value requires Architect re-review and must preserve the inner-before-outer ordering.
