...
export function validatePackagedDetails(value, { passed = false, sinkIdentity = null } = {}) {
  ...
  assert([
    ...
    "install-execution",
    "install-convergence",
    "install-convergence-matching",
    "install-convergence-unknown",
    "install-convergence-mixed",
    "install-convergence-observer-error",
    "install-validation",
    ...
    "uninstall-convergence-matching",
    "uninstall-convergence-unknown",
    "uninstall-convergence-mixed",
    "uninstall-convergence-observer-error",
    "cleanup-processes",
    "cleanup-uninstall",
    "cleanup-convergence",
    "cleanup-convergence-matching",
    "cleanup-convergence-unknown",
    "cleanup-convergence-mixed",
    "cleanup-convergence-observer-error",
