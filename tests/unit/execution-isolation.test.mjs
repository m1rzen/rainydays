...
test("SEC-03 production identity parser rejects every native/build drift without mutating checkout", { skip: process.platform !== "win32" || process.arch !== "x64" }, async () => {
  ...
  for (const apply of [
    ...
    value => { value.testProjection = null; },
    value => { value.testProjection.manifest.path = ".sec03-native-test/other.json"; },
    value => { value.testProjection.manifest.sha256 = "bad"; },
  ...
  for (const apply of [
    ...
    value => { value.versions.executionIsolation.testProjection = null; },
    value => { value.versions.executionIsolation.testProjection.manifest.bytes = 0; },
    value => { value.versions.executionIsolation.testProjection.manifest.sha256 = "bad"; },
